...
define config.name = _("Inkbound", color = "#ffffff")
...
define gui.about = _p(""" a freelance writer game
""")
...
define config.save_directory = "Inkbound-1755786600"
